...
system.bus.init_data(subs_param_value=True)
system.pq.init_data(subs_param_value=True)
system.line.init_data(subs_param_value=True)
system.pv.init_data(subs_param_value=True)
system.slack.init_data(subs_param_value=True)
