...
system.bus._init_data(subs_param_value=False)
system.pq._init_data(subs_param_value=False)
system.line._init_data(subs_param_value=False)
system.pv._init_data(subs_param_value=False)
system.slack._init_data(subs_param_value=False)
